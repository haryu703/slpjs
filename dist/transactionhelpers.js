...
var TransactionHelpers = /** @class */ (function () {
    ...
    TransactionHelpers.prototype.simpleTokenSend = function (tokenId, sendAmounts, inputUtxos, tokenReceiverAddresses, changeReceiverAddress, requiredNonTokenOutputs, extraFee) {
        ...
        var totalTokenInputAmount = inputUtxos
            .filter(function (txo) {
            return _1.Slp.preSendSlpJudgementCheck(txo, tokenId);
        })
        ...
        // Get token_type
        var token_type = inputUtxos.filter(function (i) { return i.slpUtxoJudgement === _1.SlpUtxoJudgement.SLP_TOKEN &&
        ...
        if (tokenChangeAmount.isGreaterThan(new bignumber_js_1.default(0))) {
            ...
            var sendOpReturn = _1.Slp.buildSendOpReturn({
                tokenIdHex: tokenId,
            ...
            txHex = this.slp.buildRawSendTx({
                ...
                input_token_utxos: _1.Utils.mapToUtxoArray(inputUtxos),
    ...
    TransactionHelpers.prototype.simpleTokenGenesis = function (tokenName, tokenTicker, tokenAmount, documentUri, documentHash, decimals, tokenReceiverAddress, batonReceiverAddress, bchChangeReceiverAddress, inputUtxos) {
        var genesisOpReturn = _1.Slp.buildGenesisOpReturn({
            ticker: tokenTicker,
            name: tokenName,
        ...
        var genesisTxHex = this.slp.buildRawGenesisTx({
            ...
            input_utxos: _1.Utils.mapToUtxoArray(inputUtxos)
        });
        // Return raw hex for this transaction
        return genesisTxHex;
    };
    ...
    TransactionHelpers.prototype.simpleNFT1ChildGenesis = function (nft1GroupId, tokenName, tokenTicker, documentUri, documentHash, tokenReceiverAddress, bchChangeReceiverAddress, inputUtxos, allowBurnAnyAmount) {
        ...
        if (inputUtxos[0].slpUtxoJudgement !== _1.SlpUtxoJudgement.SLP_TOKEN) {
    ...
    TransactionHelpers.prototype.simpleTokenMint = function (tokenId, mintAmount, inputUtxos, tokenReceiverAddress, batonReceiverAddress, changeReceiverAddress) {
        ...
        var token_type = inputUtxos.filter(function (i) { return i.slpUtxoJudgement === _1.SlpUtxoJudgement.SLP_BATON; })[0].slpTransactionDetails.versionType;
        // 1) Create the Send OP_RETURN message
        var mintOpReturn = _1.Slp.buildMintOpReturn({
            tokenIdHex: tokenId,
        ...
        var txHex = this.slp.buildRawMintTx({
            input_baton_utxos: _1.Utils.mapToUtxoArray(inputUtxos),
    ...
    TransactionHelpers.prototype.build_P2SH_multisig_redeem_data = function (m, pubKeys) {
        ...
        var addr = this.slp.BITBOX.Address.fromOutputScript(this.slp.BITBOX.Script.encodeP2SHOutput(this.slp.BITBOX.Crypto.hash160(redeemScript)));
        return {
            m: m,
            pubKeys: pubKeys,
            address: _1.Utils.toSlpAddress(addr),
